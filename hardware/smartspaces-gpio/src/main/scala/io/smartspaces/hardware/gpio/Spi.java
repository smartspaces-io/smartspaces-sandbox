 ...
 */
public interface Spi extends ManagedResource {
   ...
   *          the data to write
   * @param selectChip
   *          {@code true} if the method should select the chip before starting
   *          the write
   * @param deselectChip
   ...
   *          the read
   * @param deselectChip
   *          {@code true} if the method should deselect the chip after the read
   *          completes
   * 
   * @return the data read
   */

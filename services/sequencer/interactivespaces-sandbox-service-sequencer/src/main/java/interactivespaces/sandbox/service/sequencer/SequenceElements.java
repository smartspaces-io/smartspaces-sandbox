...
public class SequenceElements {
  ...
  /**
   * Create a sequence element that will repeat a collection of elements a given number of times.
   *
   * <p>
  ...
  /**
   * Create an ActionElement that runs the given sequence of ActionElements in order.
   *
   * @param elements

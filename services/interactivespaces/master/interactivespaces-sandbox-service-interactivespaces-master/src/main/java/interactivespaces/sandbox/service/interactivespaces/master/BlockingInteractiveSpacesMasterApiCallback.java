 ...
 */
public class BlockingInteractiveSpacesMasterApiCallback implements InteractiveSpacesMasterApiMessageHandler {
   ...
   */
  public BlockingInteractiveSpacesMasterApiCallback() {
    this(1);
  }
   ...
   */
  public BlockingInteractiveSpacesMasterApiCallback(int count) {
    countdown = new CountDownLatch(count);
  }

  @Override
  public void onMasterApiMessage(InteractiveSpacesMasterClient client, Map<String, Object> response) {
  ...
  /**
   * Wait for all requested callbacks. Will only block for the requested timeout.
   *
   * @param timeout
   *          the time to wait
   * @param unit

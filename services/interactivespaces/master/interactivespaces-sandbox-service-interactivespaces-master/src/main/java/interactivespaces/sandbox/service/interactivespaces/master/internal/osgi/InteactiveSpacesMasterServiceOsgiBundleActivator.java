 ...
 */
public class InteactiveSpacesMasterServiceOsgiBundleActivator extends InteractiveSpacesServiceOsgiBundleActivator {
  @Override
  protected void allRequiredServicesAvailable() {
    registerNewInteractiveSpacesService(new NativeInteractiveSpacesMasterClientService());
  }
}

...
public class OpenSoundControlMethodDispatcher {
   ...
   */
  private OpenSoundControlMethodCollection unknownMessageMethods =
      new OpenSoundControlMethodCollection();
   ...
   *
   * <p>
   * Unknown OSC messages for this dispatcher are defined to be ones that did
   * not have an explicit address registered for handling them.
   *
   * @param method
   *          the method
   */

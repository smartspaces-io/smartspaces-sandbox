...
/**
 * Implementations of this interface expose their runtime state so that it can be more easily monitored.
 *
...
public interface RuntimeStateMonitorable {
   ...
   *
   * <p>
   * This value will not be {@code null} only if the runtime state is {@code RuntimeState.CRASHED}.
   *

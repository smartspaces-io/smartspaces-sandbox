...
/**
 * A DMX control endpoint which sends a generic protocol over a serial connection.
 *
...
public class GenericSerialDmxControlEndpoint implements DmxControlEndpoint {
  ...
  public void writeDmxData(int channel, int... data) {
    StringBuilder builder = new StringBuilder().append(channel).append(GENERIC_PROTOCOL_CHANNEL_IDENTIFIER);

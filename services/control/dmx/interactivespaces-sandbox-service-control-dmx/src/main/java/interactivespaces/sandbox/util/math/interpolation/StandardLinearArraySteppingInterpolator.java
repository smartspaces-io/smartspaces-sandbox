 ...
 *
 * <p>
 * Linear interplotation is used. The increments are precalculated and only additions are done for each step.
 *
...
public class StandardLinearArraySteppingInterpolator implements ArraySteppingInterpolator {
  ...
  /**
   * The array of increments that are added to the current values to move one step.
   */
  ...
  /**
   * Check the value array to see if it matches the number expected for the interpolator.
   *
   * @param values

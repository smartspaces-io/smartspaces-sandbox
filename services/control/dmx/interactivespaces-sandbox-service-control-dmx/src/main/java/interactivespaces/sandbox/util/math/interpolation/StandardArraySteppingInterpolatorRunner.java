...
import interactivespaces.sandbox.util.concurrency.BaseManagedCommandRunner;
...
public class StandardArraySteppingInterpolatorRunner extends BaseManagedCommandRunner implements
   ...
   *
   * <p>
   * This class uses the {@link StandardLinearArraySteppingInterpolator}, see the class for details.
   *
   * @param numberValues
   ...
   */
  public static StandardArraySteppingInterpolatorRunner newLinearRunner(int numberValues, long totalDuration,
      long updateInterval, ArraySteppingInterpolatorRunnerListener listener, ManagedCommands managedCommands, Log log) {

    ArraySteppingInterpolator interpolator =
        new StandardLinearArraySteppingInterpolator(numberValues, (int) (totalDuration / updateInterval));

    return new StandardArraySteppingInterpolatorRunner(totalDuration, updateInterval, interpolator, listener,
        managedCommands, log);
  }
  ...
  protected void performTask() {
    try {
      ...
      // TODO(keith): Decide if this should then abort the interpolation run or if the abortion should be settable.

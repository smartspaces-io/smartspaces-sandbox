 ...
 */
public class RemoteControlServiceOsgiBundleActivator extends InteractiveSpacesServiceOsgiBundleActivator {
  @Override
  protected void allRequiredServicesAvailable() {
    registerNewInteractiveSpacesService(new NetworkLircRemoteControlCommunicationEndpointService());
  }
}

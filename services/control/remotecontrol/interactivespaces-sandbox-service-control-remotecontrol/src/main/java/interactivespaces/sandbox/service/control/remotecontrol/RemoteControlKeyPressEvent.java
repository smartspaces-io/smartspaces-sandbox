...
/**
 * A key press event that has happened from an {@link RemoteControlCommunicationEndpoint}.
 *
...
public class RemoteControlKeyPressEvent {
   ...
   *
   * <p>
   * This count is starts at 0 every time a new key is pressed and increments by 1 each sample for as long as the key
   * remains pressed.
   */
   ...
   *
   * @param remoteId
   *          the ID for the Remote Control which created the event, can be {@code null}
   * @param keyCode
   *          the key
   * @param count
  ...
  public String toString() {
    return "RemoteControlKeyPressEvent [keyCode=" + keyCode + ", currentKeyPressCount=" + currentKeyPressCount
        + ", remote=" + remoteId + "]";
  }
}

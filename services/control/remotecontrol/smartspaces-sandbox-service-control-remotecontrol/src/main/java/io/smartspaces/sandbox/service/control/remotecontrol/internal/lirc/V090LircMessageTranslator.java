...
import io.smartspaces.sandbox.service.control.remotecontrol.RemoteControlKeyPressEvent;
...
public class V090LircMessageTranslator implements LircMessageTranslator {
  ...
  public RemoteControlKeyPressEvent parseEvent(String eventString) {
    ...
    try {
      return new RemoteControlKeyPressEvent(
          new String(components[LIRC_PROTOCOL_POSITION_REMOTE_ID]), new String(
              components[LIRC_PROTOCOL_POSITION_KEY_CODE]), Integer.parseInt(
              components[LIRC_PROTOCOL_POSITION_COUNT], 16));

...
import io.smartspaces.sandbox.service.control.remotecontrol.BaseRemoteControlCommunicationEndpoint;
...
/**
 * An {@link RemoteControlCommunicationEndpoint} which uses the LIRC network
 * connection.
 *
 * @author Keith M. Hughes
 */
public class NetworkLircRemoteControlCommunicationEndpoint extends
    BaseRemoteControlCommunicationEndpoint {
  ...
  public void startup() {
    networkEndpoint =
        networkService.newStringClient(messageTranslater.getMessageDelimiters(),
            CharsetUtil.ISO_8859_1, lircHost, lircPort, getLog());

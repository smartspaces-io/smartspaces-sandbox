...
public class StandardBluezBluetoothProvider implements BluetoothProvider {
  public static void main(String[] args) throws Exception {
    ...
    BluetoothDevice device = adapter.newDevice(address);
    device.startup();
  ...
  public void startup() throws Exception {
    ...
    DBus dbus =
        dbusConnection.getRemoteObject("org.freedesktop.DBus", "/or/freedesktop/DBus", DBus.class);

    bluezDbusBusName = dbus.GetNameOwner("org.bluez");

    bluezObjectManager =
        (ObjectManager) dbusConnection.getRemoteObject("org.bluez", "/", ObjectManager.class);
    ...
    dbusConnection.addSigHandler(ObjectManager.InterfacesAdded.class, bluezDbusBusName,
        bluezObjectManager, interfacesAddedSignalHandler);
    dbusConnection.addSigHandler(ObjectManager.InterfacesRemoved.class, bluezDbusBusName,
        bluezObjectManager, interfacesRemovedSignalHandler);
  }

  @Override
  public void shutdown() throws Exception {
    dbusConnection.removeSigHandler(ObjectManager.InterfacesAdded.class,
        interfacesAddedSignalHandler);
    dbusConnection.removeSigHandler(ObjectManager.InterfacesRemoved.class,
  ...
  private List<String> getObjectsByInterface(String objectInterface) {
    ...
    for (Entry<Path, Map<String, Map<String, Variant>>> objectByPath : bluezObjectManager

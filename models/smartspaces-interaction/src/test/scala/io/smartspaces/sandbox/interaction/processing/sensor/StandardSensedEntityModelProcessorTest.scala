...
import io.smartspaces.sandbox.interaction.entity.SimpleMeasurementTypeDescription
import io.smartspaces.sandbox.interaction.entity.SimplePhysicalSpaceSensedEntityDescription
import io.smartspaces.sandbox.interaction.entity.SimpleSensorChannelDetail
...
class StandardSensedEntityModelProcessorTest extends JUnitSuite {
  ...
  @Test def testModelNoValueUpdate(): Unit = {
    ...
    val sensorModel = new SimpleSensorEntityModel(sensor, completeSensedEntityModel)
